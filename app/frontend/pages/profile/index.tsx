    ...
    <AppLayout title="Profile">
      <div className="max-w-xl space-y-8">
        ...
        <div className="flex items-center gap-4">
          <div className="flex items-center justify-center w-16 h-16 rounded-2xl bg-blue-600 text-white text-xl font-bold shadow-lg shadow-blue-200 shrink-0 overflow-hidden">
            {user?.avatar_url ? (
              <img
                src={user.avatar_url}
          ...
          <div>
            <h2 className="text-xl font-bold text-gray-900">{user?.name ?? 'Your Profile'}</h2>
